...
const DefenseRequestView: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 px-4 sm:px-0">
      ...
      {/* Research Committee & Student Groups */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">Research Committee & Student Groups</h2>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4 flex items-center space-x-2">
            ...
            <span>Student Groups & Research Titles</span>
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            {request.studentGroups.map((group, index) => (
              <div key={group.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-3 text-base flex items-center space-x-2">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-gray-200 font-medium text-sm">{group.researchTitle}</p>
                  </div>
                  
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Students</p>
                    <p className="text-gray-800 dark:text-gray-200 text-sm">{group.students.join(', ')}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4 flex items-center space-x-2">
            ...
            <span>Panel Members Summary</span>
          </h3>
